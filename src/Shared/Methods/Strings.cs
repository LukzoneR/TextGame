...
public class Strings
{
   ...
   "Press any key to open...", //28
   "After taking the treasures, you exit the dark tunnel. The air grows heavier, and unsettling sounds echo around you.", //29
   "Suddenly, the ground begins to shake, and a giant shadow rises before you.", //30
   "It's the Guardian of Darkness, a terrifying demon who protects the forest from unwelcome intruders.", //31
   "You must defeat him to escape this place and move closer to your goal.", //32
   //right
